...
import ActivityCard from "@/components/activities/ActivityCard";
import AddActivityDialog from "@/components/activities/AddActivityDialog"; // Corrected import name
...
export default function Activities() {
  ...
  const loadData = async () => {
    ...
    try {
      const [activitiesData, leadsData] = await Promise.all([
        Activity.list('-scheduled_date', 50), // Pass sort and limit
        Lead.list('-createdAt', 100) // Pass sort and limit
      ]);
